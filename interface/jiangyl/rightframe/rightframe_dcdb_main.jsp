...
<body style="margin:0 auto">
	<table cellspacing="0" class="ListStyle" style="table-layout: fixed;">
		<colgroup>
			...
			<col width="50%" _itemid="1" style="width: 50%;">
			<col width="25%" _itemid="2" style="width: 20%;">
			<col width="25%" _itemid="3" style="width: 30%;">
		</colgroup>
		<thead>
			<tr class="HeaderForXtalbe">
				<th align="left" title=""
					style="height: 30px; text-overflow: ellipsis; white-space: nowrap; word-break: keep-all; overflow: hidden; display: none;"></th>
				<th _itemid="1" align="left" title="局长意见"
					style="height: 30px; text-overflow: ellipsis; white-space: nowrap; word-break: keep-all; overflow: hidden; width: 50%;">局长意见</th>
				<th _itemid="2" align="left" title="签字"
					style="height: 30px; text-overflow: ellipsis; white-space: nowrap; word-break: keep-all; overflow: hidden; width: 25%;">签字</th>
				<th _itemid="3" align="left" title="签字时间"
					style="height: 30px; text-overflow: ellipsis; white-space: nowrap; word-break: keep-all; overflow: hidden; width: 25%;">签字时间</th>
			</tr>
		</thead>
		<tbody>
		<%
			String _requestid = Util.null2String(request.getParameter("requestid"));
			weaver.interfaces.action.DCDB_JLDSIGN DCDB_JLDSIGN = new weaver.interfaces.action.DCDB_JLDSIGN();
			...
			java.util.List<java.util.Map<String, String>> listMap = DCDB_JLDSIGN.getDTData(user,utMap,request,response);
			java.lang.StringBuffer tablesb = new java.lang.StringBuffer();
			for(java.util.Map<String, String> lMap : listMap) {
				String _sign = lMap.get("sign");
				...
				tablesb.append("<td spacevalue=\"300\" align=\"left\" title=\""+_yijian+"\" style=\"height: 30px; vertical-align: middle; white-space: nowrap; text-overflow: ellipsis; word-break: keep-all; overflow: hidden;\">"+_yijian+"</td>");
				tablesb.append("<td spacevalue=\"300\" align=\"left\" title=\""+_sign+"\" style=\"height: 30px; vertical-align: middle; white-space: nowrap; text-overflow: ellipsis; word-break: keep-all; overflow: hidden;\">"+_sign+"</td>");
				tablesb.append("<td spacevalue=\"300\" align=\"left\" title=\""+_riqi+"\" style=\"height: 30px; vertical-align: middle; white-space: nowrap; text-overflow: ellipsis; word-break: keep-all; overflow: hidden;\">"+_riqi+"</td>");
				tablesb.append("</tr>");
