...
<table class="LayoutTable" id="" style="display:;">
				...
				<table class="LayoutTable" style="width:100%;height:30px;">
					...
					<tbody>
						<tr class="groupHeadHide" style="background-color: #F2F2F2">
							<td class="interval">
								<span class="groupbg"> </span>
								<span class="e8_grouptitle">公文收文办理局领导批办意见：</span>
							</td>
							<td class="interval" colspan="2" style="text-align:right;">
								<span class="toolbar">	
								</span>															
		...
		<%
			...
			String sqlwhere=" a.requestId in(select requestid from workflow_requestbase  where mainRequestId= (select mainRequestId from workflow_requestbase where requestid="+_requestid+") and workflowid=102) and a.requestId=b.requestid";
				...
				<table class="LayoutTable" style="width:100%;height:30px;">
					...
					<tbody>
						<tr class="groupHeadHide" style="background-color: #F2F2F2">
							<td class="interval">
								<span class="groupbg"> </span>
								<span class="e8_grouptitle">部门办理情况</span>
							</td>
							<td class="interval" colspan="2" style="text-align:right;">
								<span class="toolbar">	
								</span>															
