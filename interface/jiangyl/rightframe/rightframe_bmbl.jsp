			...
			<td colspan="2">
				...
				<tbody>
					...
					if("".equals(_requestid) || "undefined".equals(_requestid)){
						...
						String atsql ="select distinct flowid,requestid,workflowid,createdate from ofs_todo_data a where a.workflowname = '公文办理收文_市局' and requestname = (select requestname from workflow_requestbase where requestid = ( select mainRequestId from workflow_requestbase where requestid = '"+_requestid+"'))";
			...
			<td colspan="2">
				<table cellspacing="0" class="ListStyle" style="table-layout: fixed;">
					...
					<%
						...
						java.util.List<java.util.Map<String, String>> listMap = BMSWBL.getData2(user,utMap,request,response);
