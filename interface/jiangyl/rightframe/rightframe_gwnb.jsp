				...
				<tbody>
					...
					if("".equals(_requestid) || "undefined".equals(_requestid)){
						...
						if("".equals(fj)) {
							...
							sb2.append("<a style=\"cursor:pointer;font-family:微软雅黑 !important;font-weight:bold; text-overflow: ellipsis; white-space: nowrap; word-break: keep-all; overflow: hidden;\" onclick=\"openWf('"+fj+"')\" title=\""+reqname+"\">"+reqname+"</a>&nbsp;");
							sb2.append("</span>");
							sb2.append("</div>");
							sb2.append("</div>");
							sb2.append("</td>");
			...
			<td colspan="4">
				<table cellspacing="0" class="ListStyle" style="table-layout: fixed;">
					...
					<%
						...
						java.util.List<java.util.Map<String, String>> listMap = GWNB.getData(user,utMap,request,response);
