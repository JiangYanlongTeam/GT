		...
		<tr class="intervalTR" _samepair="showgroup" style="display:">
			<td colspan="2">
				<table cellspacing="0" class="ListStyle" style="table-layout: fixed;">
					...
					<tbody>
					<%
						weaver.interfaces.action.GWHYTZ GWHYTZ = new weaver.interfaces.action.GWHYTZ();
						...
						java.util.List<java.util.Map<String, String>> listMap = GWHYTZ.getData(user,utMap,request,response);
