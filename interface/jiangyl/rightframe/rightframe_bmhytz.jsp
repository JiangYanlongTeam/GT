		...
		<tr class="intervalTR" _samepair="showgroup" style="display:">
			<td colspan="2">
				<table cellspacing="0" class="ListStyle" style="table-layout: fixed;">
					...
					<tbody>
					<%
						weaver.interfaces.action.BMHYTZ BMHYTZ = new weaver.interfaces.action.BMHYTZ();
						...
						java.util.List<java.util.Map<String, String>> listMap = BMHYTZ.getData(user,utMap,request,response);
